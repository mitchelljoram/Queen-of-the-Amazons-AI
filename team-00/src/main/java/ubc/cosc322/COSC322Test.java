...
public class COSC322Test extends GamePlayer{
    ...
    public void handleGameActionMove(Map<String, Object> msgDetails) {
        ...
        if(board.allies[0].actions.actions.size() == 0 && board.allies[1].actions.actions.size() == 0 
        && board.allies[2].actions.actions.size() == 0 && board.allies[3].actions.actions.size() == 0) {
        ...
        //board.printBoard();
        // game over check
        for(Queen queen: board.enemies) {
        	queen.actions.getActions(board,queen);
        }
        if(board.enemies[0].actions.actions.size() == 0 && board.enemies[1].actions.actions.size() == 0 
        && board.enemies[2].actions.actions.size() == 0 && board.enemies[3].actions.actions.size() == 0) {
